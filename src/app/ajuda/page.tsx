        ...
        <section className="bg-[#F8C127] dark:!bg-[#F8C127]">
          <div className="max-w-[1300px] mx-auto px-6 py-10 lg:py-14 flex flex-col lg:flex-row gap-8 lg:gap-20 items-start">
            <div className="lg:w-1/3">
              <h1 className="text-4xl lg:text-[52px] font-extrabold text-[#111f3d] dark:text-[#111f3d] leading-[1.05] tracking-tight">
                Centro de
                <br />
                Ajuda
              </h1>
            ...
            <div className="flex-1 w-full lg:mt-2">
              <div className="relative">
                <input
                  ...
                  className="w-full h-[52px] rounded-lg border border-[#111f3d] bg-[#FDF9F0] px-5 pr-12 outline-none text-[16px] text-[#111f3d] placeholder:text-[#111f3d] focus:ring-2 focus:ring-[#111f3d]/20 transition-all dark:bg-[#FDF9F0] dark:border-[#111f3d] dark:text-[#111f3d] dark:placeholder:text-[#111f3d]"
                />
                <Search className="absolute right-4 top-1/2 -translate-y-1/2 w-[22px] h-[22px] text-[#111f3d] stroke-[2] dark:text-[#111f3d]" />
              </div>

              <div className="flex flex-wrap items-center gap-x-5 gap-y-2 mt-4 text-[13px] text-[#111f3d] dark:text-[#111f3d]">
                <span className="font-bold text-[14px]">Termos Populares</span>
                <button className="hover:underline hover:underline-offset-2 transition-all dark:text-[#111f3d]">
                  Cookies
                </button>
                <button className="hover:underline hover:underline-offset-2 transition-all dark:text-[#111f3d]">
                  Condições
                ...
                >
                  <button
                    ...
                    className={`w-full transition-colors px-6 py-4 flex justify-between items-center text-left ${
                      openFaq === faq.id ? "bg-white dark:bg-black" : "bg-[#FCEFB4] hover:bg-[#fae899] dark:bg-black dark:hover:bg-white/10"
                    }`}
                  >
