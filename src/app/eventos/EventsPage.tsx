...
const EventsPage = () => {
  ...
  const filtered = activeCategory === "Todos" ? displayEvents : displayEvents.filter((e) => e.category === activeCategory);
        ...
        <section className="section-padding bg-section-alt">
          <div className="container max-w-5xl mx-auto">
            <div className="text-center mb-10">
              <h1 className="font-display text-4xl md:text-5xl font-bold text-foreground">Agenda de Eventos</h1>
              <p className="text-muted-foreground mt-3">Descubra as próximas atividades e eventos na freguesia.</p>
            </div>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {event.isPast && <span className="text-xs bg-muted text-muted-foreground px-2 py-0.5 rounded-full">Passado</span>}
                    </div>
            ...
            {filtered.length === 0 && (
              <p className="text-center text-muted-foreground py-16">Sem eventos nesta categoria.</p>
            )}
          </div>
        </section>
      </main>
