            ...
            <div className="container relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
              ...
              <div className="w-full md:max-w-xl">
                <div className="flex w-full mb-3 shadow-lg">
                  ...
                  />
                  <button className="bg-white px-6 font-semibold text-[#1c2841] border-l border-gray-200 rounded-r-md hover:bg-gray-50 transition-colors dark:bg-black dark:text-white dark:border-white/20 dark:hover:bg-white/10">
                    Pesquisar
                  </button>
                </div>
