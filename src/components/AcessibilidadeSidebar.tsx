  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundColor: "#ffffff", color: "#111827", boxShadow: "-4px 0 24px rgba(0,0,0,0.15)" }}
      >
        ...
        <div className="px-5 py-5 flex flex-col gap-6 flex-1">
          <div>
            <p className="text-xs font-bold uppercase tracking-wide mb-3" style={{ color: "#6b7280" }}>Acessibilidade</p>
            <div className="flex flex-col gap-2">
              <button
                onClick={handleReadAloud}
                className="flex items-center gap-3 border rounded-lg px-4 py-2.5 text-sm font-medium transition"
                style={{ backgroundColor: reading ? "#1C2E56" : "transparent", color: reading ? "#ffffff" : "#1C2E56", borderColor: reading ? "#1C2E56" : "#d1d5db" }}
              >
              ...
              <button
                ...
                className="flex items-center gap-3 border rounded-lg px-4 py-2.5 text-sm font-medium transition"
                style={{ backgroundColor: largeFont ? "#1C2E56" : "transparent", color: largeFont ? "#ffffff" : "#1C2E56", borderColor: largeFont ? "#1C2E56" : "#d1d5db" }}
              >
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-wide mb-3" style={{ color: "#6b7280" }}>Informacao util</p>
            <div className="flex flex-col gap-3 text-sm" style={{ color: "#6b7280" }}>
              ...
              <a href="tel:234427832" className="flex items-center gap-2 border rounded-lg px-4 py-2.5 font-medium transition" style={{ color: "#111827", borderColor: "#d1d5db" }}>
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-wide mb-3" style={{ color: "#6b7280" }}>Esta com dificuldades?</p>
            <Link href="/ajuda" onClick={() => setOpen(false)} className="flex items-center justify-between w-full font-bold rounded-lg px-4 py-3 text-sm transition" style={{ backgroundColor: "#f59e0b", color: "#1C2E56" }}>
          ...
          <div className="flex flex-col gap-2">
            {faqs.map((faq, i) => (
              <div key={i} className="border rounded-lg overflow-hidden" style={{ borderColor: "#e5e7eb" }}>
                ...
                {faqOpen === i && (
                  <div className="px-4 py-3 text-xs border-t" style={{ color: "#6b7280", borderColor: "#e5e7eb" }}>
