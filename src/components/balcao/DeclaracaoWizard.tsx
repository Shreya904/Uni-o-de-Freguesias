                ...
                return (
                  <div key={label} className="flex flex-col items-center gap-2">
                    <div className={`w-9 h-9 rounded-full flex items-center justify-center text-sm font-semibold border-2 ${
                      isActive ? "bg-[#C41230] text-white border-[#C41230]" : isDone ? "bg-[#C41230] text-white border-[#C41230]" : "border-border text-muted-foreground"
                    }`}>{n}</div>
  ...
  return (
    <div>
      ...
      <p className="text-sm text-muted-foreground mb-6">
        Deverá deslocar-se aos serviços da junta para efetuar o pagamento e confirmar a sua participação.
      </p>
      <p className="text-xs text-muted-foreground mb-4">
        Agora só falta preencher os dados do objeto do requerimento. Clique no botão ao lado para continuar.
      </p>
  ...
  return (
    <div>
      ...
      <p className="text-sm text-muted-foreground mb-2">
        Os formulários/declarações/requerimentos e os regulamentos da União das Freguesias de Glória e Vera Cruz podem ser consultados em www.ufgloriaveracruz.pt.
      </p>
      <p className="text-sm text-muted-foreground mb-6">
