              ...
              {steps.map((label, i) => {
                ...
                return (
                  <div key={label} className="flex flex-col items-center gap-2">
                    ...
                    <span className={`text-xs ${isActive ? "text-[#C41230] font-medium" : "text-muted-foreground dark:text-white/70"}`}>{label}</span>
                  </div>
                );
              })}
            </div>
  ...
  return (
    <div className="mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl">
        ...
        <div className="md:col-span-2">
          <label className="text-sm text-muted-foreground dark:text-white/70">Data de nascimento <span className="text-xs">(Necessário)</span></label>
      ...
      {["1º Proponente", "2º Proponente"].map((label, idx) => (
        <div key={idx} className="mb-8">
          ...
          <div className="space-y-3 max-w-xl">
            ...
            <div className="flex items-center gap-3">
              <span className="text-sm text-muted-foreground dark:text-white/70 w-56">Carregar a fotocópia do Cartão de Contribuinte</span>
