    ...
    <div className="container max-w-6xl mx-auto px-4 py-10 flex gap-10">
          ...
          {sidebarItems.map((item) => (
            <li key={item.type} className="flex items-start gap-2">
              ...
              />
               ...
               <a href={item.href} className={active === item.type ? "text-[#C41230] font-medium" : "hover:text-foreground transition"}>{item.label}</a>
            </li>
          ))}
        </ul>
      ...
      <div className="flex-1">
              ...
              <div key={label} className="flex flex-col items-center gap-2 min-w-[60px]">
                ...
                <span
                  className={`text-xs text-center ${
                    isActive ? "text-[#C41230] font-medium" : "text-muted-foreground"
                  }`}
                >
                  {label}
                </span>
        ...
        <div className="space-y-3">
          ...
          <details className="bg-amber-50 rounded-lg p-4 cursor-pointer">
            <summary className="font-medium text-foreground">
              Sinto-me só preciso de ajuda como fazer?
            </summary>
          </details>
        </div>
      </div>
  ...
  return (
    <div>
      ...
      <p className="text-sm text-muted-foreground mb-2">
        Os formulários/declarações/requerimentos e os regulamentos da União das Freguesias de
        Glória e Vera Cruz podem ser consultados em www.ufgloriaveracruz.pt.
      </p>
      ...
      <p className="text-xs text-muted-foreground mb-2">
        Para mais informações sobre as práticas de privacidade da União das Freguesias de
        Glória e Vera Cruz consulte a nossa página da privacidade ou envie-nos um email para
      ...
      <p className="text-xs text-muted-foreground mb-4">
        Tudo preenchido e pronto a enviar! Resta clicar no botão ao lado para confirmar o
        envio do seu pedido.
      </p>
